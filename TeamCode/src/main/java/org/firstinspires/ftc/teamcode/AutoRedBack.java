...
@Autonomous(name = "2024: Auto Red Back (New)", group = "Robot")
public class AutoRedBack extends LinearOpMode {
    ...
    private AutoRedBack.Location objectLocation = null;
    ...
    private final long TIME_SLEPT_AFTER_DROP = 50; //changes how long the robot sleeps for after dropping the purple pixel
...
//            purplePixelGripper.setPosition(CENTER_GRIPPER_OPEN);  //  WORK Need to confirm proper operation of this servo and what direction is needed to drop the pixel.
            FindRedLineDrive();
            objectFound = true;
            objectLocation = AutoRedBack.Location.First;
...
//                purplePixelGripper.setPosition(CENTER_GRIPPER_OPEN);
                objectFound = true;
                objectLocation = AutoRedBack.Location.Second;
...
//            purplePixelGripper.setPosition(CENTER_GRIPPER_OPEN);
            FindRedLineDrive();
            objectLocation = AutoRedBack.Location.Third;
 ...
 */
    ...
    public boolean encoderDrive(double speed,
        ...
        if (opModeIsActive()) {
            ...
            // instead of dropping the pixel here I've changed the code to return a boolean if the object is found.
