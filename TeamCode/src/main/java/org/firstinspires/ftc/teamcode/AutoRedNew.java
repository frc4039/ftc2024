...
public class AutoRedNew extends LinearOpMode{
    ...
    private AutoRedNew.Location objectLocation = null;
...
//            purplePixelGripper.setPosition(CENTER_GRIPPER_OPEN);  //  WORK Need to confirm proper operation of this servo and what direction is needed to drop the pixel.
            FindRedLineDrive();
            objectFound = true;
            objectLocation = AutoRedNew.Location.First;
...
//                purplePixelGripper.setPosition(CENTER_GRIPPER_OPEN);
                objectFound = true;
                objectLocation = AutoRedNew.Location.Second;
...
//            purplePixelGripper.setPosition(CENTER_GRIPPER_OPEN);
            FindRedLineDrive();
            objectLocation = AutoRedNew.Location.Third;
